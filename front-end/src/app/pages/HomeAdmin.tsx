...
export function HomeAdmin() {
    ...
    const perfil = localStorage.getItem("perfil"); // 'R' ou 'M'

    return (
        <div className="flex flex-col min-h-screen w-screen bg-[#c4d2eb77]">
            <Header />

            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center md:flex-nowrap gap-6 py-6 md:my-60 flex-wrap">

                {/* Card - Visualizar Respostas (todos veem) */}
                <div
                ...
                {/* Card - Cadastrar Resposta (todos veem) */}
                <div
                    className="bg-white p-6 rounded-lg shadow-md w-full max-w-xs h-48 text-center cursor-pointer hover:shadow-lg transition flex flex-col items-center justify-between"
                ...
                {/* Card - Gerenciar Categorias (somente perfil M) */}
                {perfil === 'M' && (
                    <div
                        className="bg-white p-6 rounded-lg shadow-md w-full max-w-xs h-48 text-center cursor-pointer hover:shadow-lg transition flex flex-col items-center justify-between"
                ...
                {/* Card - Gerenciar Usuários (somente perfil M) */}
                {perfil === 'M' && (
                    <div
                        className="bg-white p-6 rounded-lg shadow-md w-full max-w-xs h-48 text-center cursor-pointer hover:shadow-lg transition flex flex-col items-center justify-between"
